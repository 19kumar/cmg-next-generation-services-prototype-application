...
router.post('/about_qualifying_child/child_date_of_birth_3', function (req, res) {
  ...
  if (child1DateOfBirthYear > 2003) {
    res.redirect('birth_certificate_3')
  } else if (child1DateOfBirthYear < 2003) {
...
router.post('/about_qualifying_child/child_date_of_birth_4', function (req, res) {
  ...
  if (child1DateOfBirthYear > 2003) {
    res.redirect('birth_certificate_4')
  } else if (child1DateOfBirthYear < 2003) {
...
router.post('/about_qualifying_child/birth_certificate_1', function (req, res) {
  res.redirect('cya_child_1')
});

router.post('/about_qualifying_child/birth_certificate_2', function (req, res) {
  res.redirect('cya_child_2')
});

router.post('/about_qualifying_child/birth_certificate_3', function (req, res) {
  res.redirect('cya_child_3')
});
router.post('/about_qualifying_child/birth_certificate_4', function (req, res) {
  res.redirect('cya_child_4')
});

router.post('/about_qualifying_child/cya_child_1', function (req, res) {
  res.redirect('add_another_child_loop_1')
});

router.post('/about_qualifying_child/cya_child_2', function (req, res) {
  res.redirect('add_another_child_loop_2')
});

router.post('/about_qualifying_child/cya_child_3', function (req, res) {
  res.redirect('add_another_child_loop_3')
});
router.post('/about_qualifying_child/cya_child_4', function (req, res) {
...
router.post('/about_qualifying_child/4cya', function (req, res) {
  res.redirect('shared_care_start')
});

router.post('/about_qualifying_child/shared_care_start', function (req, res) {
  res.redirect('joint_shared_care')
});

router.post('/about_qualifying_child/shared_care_start2', function (req, res) {
  res.redirect('joint_shared_care2')
});

router.post('/about_qualifying_child/shared_care_start3', function (req, res) {
  res.redirect('joint_shared_care3')
});

router.post('/about_qualifying_child/joint_shared_care3', function (req, res) {
  res.redirect('cyalast')
});

router.post('/about_qualifying_child/cyalast', function (req, res) {
  res.redirect('shared_care_cya4')
});

router.post('/about_qualifying_child/joint_shared_care', function (req, res) {
  res.redirect('joint_shared_care_is_this_the_same')
});
router.post('/about_qualifying_child/joint_shared_care2', function (req, res) {
  res.redirect('joint_shared_care_is_this_the_same2')
});

router.post('/about_qualifying_child/which_children_stay_overnight', function (req, res) {
  res.redirect('shared_care_cya2')
});

router.post('/about_qualifying_child/shared_care_cya4', function (req, res) {
  res.redirect('done')
});

router.post('/about_qualifying_child/shared_care_cya2', function (req, res) {
  res.redirect('shared_care_start2')
});
