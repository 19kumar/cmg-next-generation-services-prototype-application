...
router.post('test_save_and_return_main_prototype_task_list', function (req, res) {
  res.redirect('applicants_name')
});

router.post('test_save_and_return_main_prototype/applicants_name', function (req, res) {
  res.redirect('applicants_date_of_birth')
});

router.post('applicants_date_of_birth', function (req, res) {
  res.redirect('applicants_national_insurance_number')
});

router.post('applicants_national_insurance_number', function (req, res) {
  res.redirect('applicants_address_manual_input2')
});

router.post('applicants_address_manual_input', function (req, res) {
  res.redirect('applicants_phone_number')
});

router.post('applicants_phone_number', function (req, res) {
...
router.post('/personal_security/personal_security_details_pin', function (req, res) {
  res.redirect('../../save_and_return_main_prototype/declaration')
