...
router.post('/about_other_parent/other_parent_date_of_birth', function (req, res) {
  res.redirect('other_parent_date_of_birth_example_2')
});

//Normal route with continue - Other parents date of birth 2
router.post('/about_other_parent/other_parent_date_of_birth_example_2', function (req, res) {
  res.redirect('other_parent_date_of_birth_example_3')
});

//Normal route with continue - Other parents date of birth 2
router.post('/about_other_parent/other_parent_date_of_birth_example_3', function (req, res) {
