...
router.post('/about_applicant/applicants_contact_files/applicants_contact_details', function (req, res) {
  let mobileQuery = req.session.data['mobile-query']

  if (mobileQuery === 'yes') {
    res.redirect('applicants_contact_text_query')
  } else {
    res.redirect('applicants_contact_home_phone')
  }
});
...
router.post('/about_applicant/applicants_contact_files/applicants_contact_home_phone', function (req, res) {
  res.redirect('applicants_email')
});
