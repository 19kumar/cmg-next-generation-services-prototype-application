...
router.post('/about_applicant/applicants_correspondence_query', function (req, res) {
  ...
  let correspondenceQuery = req.session.data['correspondence_query']
...
//----------
    ...
    //Normal route with continue - exemption domestic abuse
    router.post('/about_applicant/applicants_contact_files/applicants_contact_text_query', function (req, res) {
      res.redirect('/cmg-app/sprint_2/contact_page_iterations/contact_page_iteration_1/tasklists/tasklist_2')
    });
