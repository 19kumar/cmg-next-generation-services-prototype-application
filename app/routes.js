...
router.use('/cmg-app/sprint_17/sprint_17_main_prototype', require('./views/cmg-app/sprint_17/sprint_17_main_prototype/routes'));
...
router.use('/cmg-app/test_save_and_return/test_save_and_return_main_prototype', require('./views/cmg-app/test_save_and_return/test_save_and_return_main_prototype/routes'));

router.use('/cmg-app/test_other_parent_info/test_other_parent_info_main_prototype', require('./views/cmg-app/test_other_parent_info/test_other_parent_info_main_prototype/routes'));
...
router.use('/cmg-app/other_parent_test_2/other_parent_test_2_main_prototype', require('./views/cmg-app/other_parent_test_2/other_parent_test_2_main_prototype/routes'));


router.use('/cmg-app/march2020/march2020_main_prototype', require('./views/cmg-app/march2020/march2020_main_prototype/routes'));
...
router.use('/cmg-app/qctestv3/qctestv3_main_prototype', require('./views/cmg-app/qctestv3/qctestv3_main_prototype/routes'));

router.use('/cmg-app/qctestv4/qctestv4_main_prototype', require('./views/cmg-app/qctestv4/qctestv4_main_prototype/routes'));
