...
$(document).ready(
  !function(e){"use strict";function t(t){this.config={},e.extend(this,r),t&&e.extend(this,t);var o={};
  for(var s in this.output_fields)void 0!==this.output_fields[s]&&(o[s]=e(this.output_fields[s]));
  this.$output_fields=o}var o=[],s={},r={
    api_key:"",output_fields:{
      ...
      address_formatters:{
        postcode_search:function(e){
          ...
          t.join(" ")},
          address_search:function(e){var t=[e.line_1];
            ...
            t.prototype.setupPostcodeInput=function(e){
              ...
              t.prototype.setupInputField=function(){
                var t=this;return e(this.input).length?this.$input=e(this.input).first():this.$input=e("<input />",{
                  type:"text",
                  id:this.input_id,
                  value:this.input_label,placeholder:this.placeholder_label}).appendTo(this.$context).addClass(this.input_class).val(this.input_label).attr("style",this.input_muted_style).submit(function(){
                    return!1}).keypress(function(e){
                      13===e.which&&t.$button.trigger("click")}).focus(function(){
                        t.$input.removeAttr("style").val("")}).blur(function(){
                          t.$input.val()||(t.$input.val(t.input_label),t.$input.attr("style",t.input_muted_style))}),
                          this.$input},t.prototype.setupLookupButton=function(){
                            var t=this;return e(t.button).length?t.$button=e(t.button).first():t.$button=e("<button />",{
                              ...
                              {t.onLookupTriggered&&t.onLookupTriggered.call(t);
                                var e=function(){var e=t.$input.val();
                                  t.last_lookup!==e&&(t.last_lookup=e,t.clearAll(),
                                  t.disableLookup(),t.executeSearch(e))};
                                  return t.shouldLookupTrigger?t.shouldLookupTrigger.call(t,e):e(),!1}),t.$button},
                                  t.prototype.disableLookup=function(e){
                                    ...
                                    t.prototype.enableLookup=function(){
                                      if(!this.button){var e=this;0===e.disable_interval?e.$button.prop("disabled",!1).html(e.button_label):setTimeout(function(){
                                        e.$button.prop("disabled",!1).html(e.button_label)},e.disable_interval)}},
                                        ...
                                        ,t.prototype.removeAll=function(){
                                          this.$context=null,e.each([this.$input,this.$button,this.$dropdown,this.$error_message],
                                            ...
                                            t.prototype.executeSearch=function(e){
                                              var t,o=this,s=function(s,r,n){o.enableLookup(),o.cacheSearchResults(n),
                                                ...
                                                t.prototype.executePostcodeSearch=function(t,o){var s=this,r={query:t,api_key:s.api_key,endpoint:s.endpoint};
                                                ...
                                                t.prototype.setDropDown=function(t){var o=this,s=o.address_formatters.postcode_search;if(o.address_search&&(s=o.address_formatters.address_search),
                                                    ...
                                                    var l;return l=e(this.dropdown_container).length?e(this.dropdown_container).first():this.$context,r.appendTo(l).change(function(){
                                                      ...
                                                      t.prototype.setErrorMessage=function(t){
                                                        ...
                                                        delete this.$error_message),t){
                                                          ...
                                                          e.idealPostcodes={defaults:function(){return r},keyCheckCache:s,lookupPostcode:function(t,o){
                                                            ...
                                                            var u={url:l,data:d,dataType:"jsonp",timeout:1e4,success:function(e,t,s){
                                                              return 2e3===e.code?o(null,e.result,e,s):4040===e.code?o(null,[],e,s):o(new Error(i(e)),[],e,s)},error:s};e.ajax(u)},
                                                              lookupAddress:function(t,o){var s,n=t.query||"",a=t.api_key||"",l=[t.endpoint||r.endpoint,"addresses"].join("/"),d={api_key:a,query:n};
                                                              s=t.error?t.error:function(e,t){return o(new Error("Request Failed: "+t),
                                                              [],null,e)},d.limit=t.limit||10,t.tags&&e.isArray(t.tags)&&(d.tags=t.tags.join(",")),t.licensee&&(d.licensee=t.licensee);
                                                              var u={url:l,data:d,dataType:"jsonp",timeout:1e4,success:function(e,t,s){
                                                                return 2e3===e.code?o(null,e.result.hits,e,s):o(new Error(i(e)),[],e,s)},error:s};
                                                                e.ajax(u)},checkKey:function(t,o,n){var i=t.api_key||"";n=n||function(){};
                                                                ...
                                                                t.licensee&&(l.data={licensee:t.licensee}),l.success=function(t){if(t&&t.result&&t.result.available){var o=s[i].success;s[i]=!0,
                                                                  e.each(o,function(e,o){o.call(null,t)})}else{var r=s[i].error;s[i]=!1,e.each(r,function(e,t){t.call()})}},
                                                                  l.error=function(){var t=s[i].error;delete s[i],e.each(t,function(e,t){t.call()})},e.ajax(l)},clearAll:function(){
                                                                    for(var e=o.length,t=0;t<e;t+=1)o[t].removeAll()}},e.fn.setupPostcodeLookup=function(s){var r=this;if(0===r.length)return r;var n=function(){
                                                                      e.each(r,function(r,n){var i=new t(s);o.push(i),i.setupPostcodeInput(e(n))}),e.isFunction(s.onLoaded)&&s.onLoaded.call(r)};if(s.check_key){
                                                                        var i={api_key:s.api_key};s.endpoint&&(i.endpoint=s.endpoint),s.licensee&&(i.licensee=s.licensee),e.idealPostcodes.checkKey(i,n,function(){
                                                                          e.isFunction(s.onFailedCheck)&&s.onFailedCheck.call(r)})}else n();return r}}(jQuery)); 
